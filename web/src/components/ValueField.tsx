import { TbFillFunction as TbFunction } from "solid-icons/tb";
...
/**
 * A text field that knows its contents may reference a value.
 *
    ...
    <div class="completing-field">
      <div class="flex items-end gap-1">
        ...
        <button
          ...
          aria-label={`Insert a value into ${properties.label}`}
          title="Insert a value"
          onClick={openPicker}
        >
          <TbFunction class="h-3.5 w-3.5" />
        </button>
      </div>
